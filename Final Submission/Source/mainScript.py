...
feature_regressions_map = {
    'Ridge': pd.read_csv("./data/Experiments/merged_path_exmpl/best_features/best_features_Ridge.csv")['Features'],
    'Lasso': pd.read_csv("./data/Experiments/merged_path_exmpl/best_features/best_features_Lasso.csv")['Features'],
    'ElasticNet': pd.read_csv("./data/Expermerged_path_exmpl/best_features/best_features_ElasticNet.csv")['Features'],
    'SVR': pd.read_csv("./data/Experiments/merged_path_exmpl/best_features/best_features_SVR.csv")['Features'],
    'MLPRegression': pd.read_csv("./data/Experiments/merged_path_exmpl/best_features/best_features_MLPRegressor.csv")['Features'],
    'RFR': pd.read_csv("./data/Experiments/merged_path_exmpl/best_features/best_features_RFR.csv")['Features'],
}
...
def main_script_runner(raw_data_file_name, using_merged=False):
    ...
    print('Checked feature is: {}'.format(checked_feature))
    # Create path folders if needed
    # Main path where data will be saved.
    path = './data/Experiments/merged_path_exmpl'
    # Results folder within the path location.
    path_results = path + '/grid_search_results/'
...
if __name__ == '__main__':
    ...
    main_script_runner(raw_data_file_name='./data/merged_all_2016-1-1-2019-10-1', using_merged=True)
